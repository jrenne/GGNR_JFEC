...
`input/paper_data.rds` contains the frozen database used for the paper. It is
the default input to the estimation and figure code. In
...
effective federal funds rate used to impose the short-real-rate moments.
